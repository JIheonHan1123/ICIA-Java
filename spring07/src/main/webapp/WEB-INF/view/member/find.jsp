				...
				<div class="tab-content">
					<div id="find_id_div" class="mb-3 mt-3">
						...
						<div class="form-group">
							<label for="email1">이메일:</label> <input type="text" class="form-control" id="email" placeholder="이메일 입력..."> <span class="helper-text" id="email_msg1"></span>
						</div>
					...
					<div id="find_password_div" class="mb-3 mt-3">
						<h2>비밀번호 찾기</h2>
						<div class="form-group">
							<label for="username">아이디:</label> <input type="text" class="form-control" id="username" placeholder="아이디 입력..." name="username"> <span class="helper-text" id="username_msg"></span>
						</div>
						<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
