...
<script>
	//$(document).ready(funtion{}) 이랑 똑같은거임 $(function()){}
	$(function() {
		...
		<main>
			...
			<section>
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td colspan="2"><img src='${member.profile}' height='200px'></td>
						</tr>
						<tr>
							<td>이메일</td>
							<td><input type="email" id="email" name="email" value="${member.email}">
								<button class="btn btn-outline-danger" id="change-email">수정하기</button></td>
						</tr>
						<tr>
							<td>생일</td>
						...
						<tr>
							<td>가입일(가입기간)</td>
							<td>${member.joinday}(${member.days}일경과)</td>
						</tr>
					</tbody>
				</table>
