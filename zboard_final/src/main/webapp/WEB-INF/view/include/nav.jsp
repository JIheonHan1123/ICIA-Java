...
<script>
	$(document).ready(function() {
		$('#logout').on('click', function(e) {
			...
			// js로 폼을 생성하면 메모리에 존재 -> submit불가 -> html에 폼을 붙인 다음에 submit
			const html = `
		...
		<div class="container-fluid">
			...
			<ul class="navbar-nav" id="menu_parent">
				<sec:authorize access="isAnonymous()">
					...
					<li class="nav-item"><a href="/member/find" class="nav-link">아이디/비번 찾기</a></li>
				...
				<sec:authorize access="isAuthenticated()">
					...
					<li class="nav-item"><a href="/member/logout" id="logout" class="nav-link">로그아웃</a></li>
				</sec:authorize>
